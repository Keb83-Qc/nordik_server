...
<div class="topbar">
    ...
    <div class="topbar-right">
        ...
        <button id="btn-hypotheses" onclick="openHypothesesModal()" title="Hypothèses"
            style="background:none;border:1px solid rgba(170,179,204,.35);border-radius:6px;color:#aab3cc;cursor:pointer;display:flex;align-items:center;gap:6px;font-size:12px;padding:5px 10px;line-height:1"
            onmouseover="this.style.borderColor='var(--gold)';this.style.color='var(--gold)'"
            onmouseout="this.style.borderColor='rgba(170,179,204,.35)';this.style.color='#aab3cc'">
        ...
        @if ($record)
            <button id="btn-manual-save" onclick="manualSave()" title="Sauvegarder maintenant"
                style="background:rgba(201,160,80,.15);border:1px solid rgba(201,160,80,.5);border-radius:6px;color:var(--gold);cursor:pointer;display:flex;align-items:center;gap:6px;font-size:12px;padding:5px 10px;line-height:1;font-weight:600"
                onmouseover="this.style.background='rgba(201,160,80,.28)'"
                onmouseout="this.style.background='rgba(201,160,80,.15)'">
        ...
        @endif
        <a href="{{ route('abf.landing', ['advisorSlug' => auth()->user()->slug ?? 'conseiller']) }}"
            style="background:none;border:1px solid rgba(170,179,204,.35);border-radius:6px;color:#aab3cc;cursor:pointer;display:flex;align-items:center;gap:6px;font-size:12px;padding:5px 10px;line-height:1;text-decoration:none"
            onmouseover="this.style.borderColor='var(--gold)';this.style.color='var(--gold)'"
            onmouseout="this.style.borderColor='rgba(170,179,204,.35)';this.style.color='#aab3cc'">
        ...
        <div class="nav-group">
            <div class="nav-group-title">
                <svg viewBox="0 0 26 24">
                    <path
                        d="M12 0q-2.484 0-4.676 0.938t-3.82 2.566-2.566 3.82-0.938 4.676 0.938 4.676 2.566 3.82 3.82 2.566 4.676 0.938 4.676-0.938 3.82-2.566 2.566-3.82 0.938-4.676-0.938-4.676-2.566-3.82-3.82-2.566-4.676-0.938zM10.148 17.531l-5.531-5.508 2.133-2.133 3.398 3.398 7.195-7.195 2.133 2.109-9.328 9.328z" />
                </svg>
                Situation actuelle
            </div>
            <button class="nav-item active" onclick="goTo('infos-perso',this)">
                <span class="dot"></span> Profil Personnel
            </button>
