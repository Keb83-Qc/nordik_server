    ...
    <div id="page-infos-perso" class="page active">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input class="form-input" id="client-prenom" type="text" value="" placeholder="Prénom"
                            oninput="updateConjointLienLabel()" />
                    </div>
                    <div class="col form-group">
                        <label class="form-label required">Nom</label>
                        <input class="form-input" id="client-nom" type="text" value=""
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <div class="date-row">
                            <input class="form-input" id="client-ddn-jour" type="text" value=""
                                placeholder="Jour" style="max-width:70px" maxlength="2"
                            ...
                            <input class="form-input" type="text" value="" placeholder="Année"
                                style="max-width:90px" id="client-naissance-annee" maxlength="4"
                    ...
                    <div class="col form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-pill"><input type="radio" name="sexe" id="masculin"
                                    value="M" /><label for="masculin">Masculin</label></div>
                            <div class="radio-pill"><input type="radio" name="sexe" id="feminin"
                                    value="F" /><label for="feminin">Féminin</label></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input class="form-input" id="client-courriel" type="email" value=""
                            placeholder="courriel@exemple.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+"
                            title="Format requis : courriel@domaine.com" />
                    </div>
                    <div class="col form-group">
                        <label class="form-label required">Réside au Canada depuis</label>
                        <input class="form-input" type="text" placeholder="Année (ex: 2010)"
                            id="client-canada-depuis" maxlength="4"
                            oninput="this.value=this.value.replace(/\D/g,'').slice(0,4)" />
                    </div>
                </div>
                <div class="row">
                    <div class="col form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-pill"><input type="radio" name="tabac" id="tabac-oui"
                                    value="oui" /><label for="tabac-oui">Oui</label></div>
                            <div class="radio-pill"><input type="radio" name="tabac" id="tabac-non"
                                    value="non" checked /><label for="tabac-non">Non</label></div>
                        </div>
                    </div>
                    <div class="col form-group">
                        <label class="form-label">Langue</label>
                        <div class="radio-group">
                            <div class="radio-pill"><input type="radio" name="langue" id="fr"
                                    value="fr" checked /><label for="fr">Français</label></div>
                            <div class="radio-pill"><input type="radio" name="langue" id="en"
                                    value="en" /><label for="en">Anglais</label></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="collapse-body">
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input class="form-input" id="client-cellulaire" type="tel" value=""
                            placeholder="514 000-0000" maxlength="12"
                    ...
                    <div class="col form-group">
                        ...
                        <input class="form-input" id="client-telephone" type="tel" placeholder="514 000-0000"
                            maxlength="12"
                            oninput="const d=this.value.replace(/\D/g,'').slice(0,10);this.value=d.length<=3?d:d.length<=6?d.slice(0,3)+' '+d.slice(3):d.slice(0,3)+' '+d.slice(3,6)+'-'+d.slice(6)" />
                    </div>
                </div>
                ...
                <div style="margin-bottom:4px">
                    ...
                    <div class="row">
                        <div class="col form-group" style="max-width:120px">
                            ...
                            <input class="form-input" type="text" id="client-addr-civique" value=""
                                oninput="syncConjointInfo()" />
                        </div>
                        <div class="col form-group">
                            <label class="form-label">Rue</label>
                            <input class="form-input" type="text" id="client-addr-rue" value=""
                                oninput="syncConjointInfo()" />
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col form-group" style="max-width:100px">
                            ...
                            <input class="form-input" type="text" id="client-addr-numero" value=""
                                oninput="syncConjointInfo()" />
                        </div>
                        <div class="col form-group">
                            <label class="form-label">Case postale</label>
                            <input class="form-input" type="text" id="client-addr-case" placeholder="—"
                                oninput="syncConjointInfo()" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col form-group">
                            ...
                            <input class="form-input" type="text" id="client-addr-ville" value=""
                                oninput="syncConjointInfo()" />
                        </div>
                        <div class="col form-group">
                        ...
                        <div class="col form-group">
                            ...
                            <input class="form-input" type="text" id="client-addr-postal" value=""
                        ...
                        <div class="col form-group">
                            ...
                            <input class="form-input" type="text" id="client-addr-pays" value="Canada" disabled
        ...
        <div id="conjoint-section" style="display:none">
            <div class="card">
                <div class="card-header"
                    style="background:#f0f3fa;display:flex;align-items:center;justify-content:space-between">
                    <span>Conjoint(e)</span>
                    {{--  <div style="display:flex;gap:12px;font-size:12px">
                        <a href="#" style="color:var(--gold);text-decoration:none;font-weight:600">Supprimer le
                            conjoint</a>
                        <a href="#" style="color:var(--navy);text-decoration:none;font-weight:600">Changer le
                            conjoint</a>
                    </div>  --}}
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col form-group">
                            <label class="form-label required">Nom</label>
                            <input class="form-input" id="conjoint-nom" type="text"
                                placeholder="Nom de famille" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col form-group">
                            <label class="form-label required">Date de naissance</label>
                            <div class="date-row">
                                <input class="form-input" id="conjoint-ddn-jour" type="text" placeholder="Jour"
                                ...
                                <input class="form-input" type="text" placeholder="Année" style="max-width:90px"
                                    id="conjoint-naissance-annee" maxlength="4"
                                    oninput="this.value=this.value.replace(/\D/g,'').slice(0,4)" />
                            </div>
                        </div>
                        <div class="col form-group">
                            <label class="form-label">Sexe</label>
                            <div class="radio-group">
                                <div class="radio-pill"><input type="radio" name="co-sexe"
                                        id="co-masculin" /><label for="co-masculin">Masculin</label></div>
                                <div class="radio-pill"><input type="radio" name="co-sexe"
                                        id="co-feminin" /><label for="co-feminin">Féminin</label></div>
                            </div>
                        </div>
                    </div>
                    <!-- État civil / Province -->
                    ...
                    <div class="row">
                        <div class="col form-group">
                            <label class="form-label">Courriel personnel</label>
                            <input class="form-input" id="conjoint-courriel" type="email"
                                placeholder="courriel@exemple.com" pattern="[^@\s]+@[^@\s]+\.[^@\s]+"
                                title="Format requis : courriel@domaine.com" />
                        </div>
                        <div class="col form-group">
                            <label class="form-label required">Réside au Canada depuis</label>
                            <input class="form-input" type="text" placeholder="Année (ex: 2010)"
                                id="conjoint-canada-depuis" maxlength="4"
                                oninput="this.value=this.value.replace(/\D/g,'').slice(0,4)" />
                        </div>
                    </div>
                    <!-- Tabac / Langue -->
                    <div class="row">
                        <div class="col form-group">
                            <label class="form-label required">Usage de tabac</label>
                            <div class="radio-group">
                                <div class="radio-pill"><input type="radio" name="co-tabac"
                                        id="co-tabac-oui" /><label for="co-tabac-oui">Oui</label></div>
                                <div class="radio-pill"><input type="radio" name="co-tabac" id="co-tabac-non"
                                        checked /><label for="co-tabac-non">Non</label></div>
                            </div>
                        </div>
                        <div class="col form-group">
                            <label class="form-label">Langue</label>
                            <div class="radio-group">
                                <div class="radio-pill"><input type="radio" name="co-langue" id="co-fr"
                                        checked /><label for="co-fr">Français</label></div>
                                <div class="radio-pill"><input type="radio" name="co-langue"
                                        id="co-en" /><label for="co-en">Anglais</label></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="collapse-body">
                    ...
                    <div class="row">
                        <div class="col form-group">
                            <label class="form-label">Cellulaire</label>
                            <input class="form-input" id="conjoint-cellulaire" type="tel"
                                placeholder="514 000-0000" maxlength="12"
                                oninput="const d=this.value.replace(/\D/g,'').slice(0,10);this.value=d.length<=3?d:d.length<=6?d.slice(0,3)+' '+d.slice(3):d.slice(0,3)+' '+d.slice(3,6)+'-'+d.slice(6)" />
                        </div>
                        <div class="col form-group">
                            <label class="form-label">Téléphone domicile</label>
                            <input class="form-input" id="conjoint-telephone" type="tel"
                                placeholder="514 000-0000" maxlength="12"
                                oninput="const d=this.value.replace(/\D/g,'').slice(0,10);this.value=d.length<=3?d:d.length<=6?d.slice(0,3)+' '+d.slice(3):d.slice(0,3)+' '+d.slice(3,6)+'-'+d.slice(6)" />
                        </div>
                    </div>
            ...
            <div class="card-body" style="overflow:visible">
              ...
              box-shadow:0 8px 24px rgba(0,0,0,.12);min-width:260px;overflow:hidden">
                        <ul style="list-style:none;padding:4px 0;margin:0">
                            <li><button class="legal-menu-item" onclick="openLegalModal('Contrat de mariage')">Contrat
                                    de mariage</button></li>
                            <li><button class="legal-menu-item"
                                    onclick="openLegalModal('Contrat de vie commune')">Contrat de vie commune</button>
                            </li>
                            <li><button class="legal-menu-item" onclick="openLegalModal('Acte d\'union civile')">Acte
                                    d'union civile</button></li>
                            <li><button class="legal-menu-item"
                                    onclick="openLegalModal('Jugement de divorce')">Jugement de divorce</button></li>
                            <li><button class="legal-menu-item"
                                    onclick="openLegalModal('Jugement de séparation de corps')">Jugement de séparation
                                    de corps</button></li>
                            <li><button class="legal-menu-item"
                                    onclick="openLegalModal('Testament')">Testament</button></li>
                            <li><button class="legal-menu-item"
                                    onclick="openLegalModal('Mandat de protection')">Mandat de protection</button></li>
                            <li><button class="legal-menu-item"
                                    onclick="openLegalModal('Ordonnance de pension alimentaire')">Ordonnance de pension
                                    alimentaire</button></li>
                            <li><button class="legal-menu-item"
                                    onclick="openLegalModal('Convention d\'achat/vente')">Convention
                                    d'achat/vente</button></li>
                            <li><button class="legal-menu-item"
                                    onclick="openLegalModal('Engagement financier envers quelqu\'un')">Engagement
                                    financier envers quelqu'un</button></li>
        ...
        background:rgba(14,16,48,.45);align-items:center;justify-content:center">
            <div
                style="background:white;border-radius:12px;width:100%;max-width:560px;
          box-shadow:0 20px 60px rgba(0,0,0,.25);overflow:hidden;margin:20px">
            ...
            display:flex;align-items:center;justify-content:space-between">
                    <h4 style="font-size:16px;font-weight:700;color:var(--navy);margin:0">Enfant ou personne à charge
                    </h4>
                    <button onclick="closeEnfantModal()"
              ...
              color:var(--muted);cursor:pointer;line-height:1;padding:0 4px">×</button>
                ...
                <div style="padding:20px 24px;max-height:70vh;overflow-y:auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col form-group">
                            ...
                            <div class="date-row">
                                <input class="form-input" id="enf-jour" type="text" placeholder="Jour"
                                    style="max-width:65px" maxlength="2"
                                    oninput="this.value=this.value.replace(/\D/g,'').slice(0,2)" />
                                ...
                                <input class="form-input" id="enf-annee" type="text" placeholder="Année"
                                    style="max-width:80px" maxlength="4"
                                    oninput="this.value=this.value.replace(/\D/g,'').slice(0,4)" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col form-group" id="enf-relation-conjoint-col" style="display:none">
                            <label class="form-label" id="enf-relation-conjoint-label">Relation avec le
                                conjoint</label>
                ...
                <!-- Modal footer -->
                <div
                    style="padding:14px 24px;border-top:1px solid var(--border);
    ...
    <div id="modal-legal"
        ...
        background:rgba(14,16,48,.45);align-items:center;justify-content:center">
        <div
            style="background:white;border-radius:12px;width:100%;max-width:520px;
          box-shadow:0 20px 60px rgba(0,0,0,.25);overflow:hidden;margin:20px">
            <!-- Modal header -->
            <div
                style="padding:20px 24px 16px;border-bottom:1px solid var(--border);
            display:flex;align-items:center;justify-content:space-between">
                <h4 id="modal-legal-title" style="font-size:16px;font-weight:700;color:var(--navy);margin:0">Document
                    légal</h4>
            ...
            <div style="padding:20px 24px;max-height:70vh;overflow-y:auto">
                ...
                <div class="form-group">
                    ...
                    <div class="date-row">
                        <input class="form-input" id="leg-jour" type="text" placeholder="Jour"
                            style="max-width:65px" maxlength="2"
                            oninput="this.value=this.value.replace(/\D/g,'').slice(0,2)" />
                        ...
                        <input class="form-input" id="leg-annee" type="text" placeholder="Année"
                            style="max-width:80px" maxlength="4"
                            oninput="this.value=this.value.replace(/\D/g,'').slice(0,4)" />
                    </div>
                </div>
