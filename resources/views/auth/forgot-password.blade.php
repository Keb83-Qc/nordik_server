...
<head>
    ...
    <title>Mot de passe oublié | VIP GPI</title>
...
<body>
    <div class="login-card position-relative">
        ...
        <div class="card-body-vip">
            <h4 class="mb-1 fw-bold text-dark text-center">Mot de passe oublié</h4>
            <p class="text-muted small mb-4 text-center">
                Entrez votre adresse courriel et nous vous enverrons un lien pour réinitialiser votre mot de passe.
            </p>

            @if (session('status'))
                <div class="alert alert-success border-0 rounded-3 mb-4 py-2 fs-6">
