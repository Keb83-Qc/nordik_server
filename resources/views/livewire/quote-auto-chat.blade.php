    ...
    <div class="response-area">
        <div class="response-container mx-auto" wire:loading.class="opacity-50 pe-none">
            ...
            <div class="input-group" wire:key="area-age">
                <input type="number" wire:model.blur="age" class="form-control form-control-lg shadow-sm"
            ...
            <div class="input-group" wire:key="area-profession">
                <input type="text" wire:model.blur="profession" class="form-control form-control-lg shadow-sm"
            ...
            <div class="input-group" wire:key="area-email">
                <input type="email" wire:model.blur="email" class="form-control form-control-lg shadow-sm"
            ...
            <div class="input-group" wire:key="area-phone">
                <input type="tel" wire:model.blur="phone" class="form-control form-control-lg"
            ...
            <div wire:key="area-license">
                <div class="input-group mb-2">
                    <input type="text" wire:model.blur="license_number" class="form-control form-control-lg"
