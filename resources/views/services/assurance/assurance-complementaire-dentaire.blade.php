...
@php
$header_title = $header_title ?? ($serviceTr->title ?? __('assurance-complementaire-dentaire.title'));
$header_bg = $header_bg ?? asset('assets/img/assuranceComplementaireDentaire/asian-happy.jpg');
@endphp
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                ...
                <h1 class="fw-bold mb-3" style="color: var(--primary-color);">{{ __('assurance-complementaire-dentaire.title') }}</h1>
                <h4 class="text-muted mb-4">{{ __('assurance-complementaire-dentaire.subtitle') }}</h4>
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceComplementaireDentaire/african-social.jpg') }}" alt="Soins de santé" class="img-fluid rounded shadow-lg">
            </div>
            <div class="col-lg-6">
                <div class="mb-4">
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceComplementaireDentaire/female-dentist.jpg') }}"
        ...
        <div class="row align-items-start">
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-lg h-100 overflow-hidden">
                    <img src="{{ asset('assets/img/assuranceComplementaireDentaire/hands-with-heart.jpg') }}" alt="Protection" class="card-img-top object-fit-cover" style="height: 200px;">
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceComplementaireDentaire/default.jpg');
