...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                {{-- Image Hero --}}
                <img src="{{ asset('assets/img/assuranceInvalidite/A-cote-texte-invalidite-introduction.jpg') }}" alt="Assurance invalidité" class="section-img rounded shadow hover-lift w-100">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="mb-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <a href="{{ url('/assurance-invalidite-de-groupe') }}" class="text-decoration-none text-dark">
                ...
                <div class="col-md-6">
                    <a href="{{ url('/assurance-invalidite-individuelle') }}" class="text-decoration-none text-dark">
                        <div class="p-4 bg-light rounded shadow-sm h-100 hover-lift border border-light">
                            <div class="d-flex align-items-center mb-3">
            ...
            <div class="col-lg-6">
                <div class="card h-100 border-0 shadow p-4 text-center" style="background: linear-gradient(135deg, #fff 0%, #f8f9fa 100%);">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div class="mb-4">
                            <img src="{{ asset('assets/img/assuranceInvalidite/VIP_Logo_Gold_Gradient10.png') }}" width="100" alt="Logo">
                        </div>
