...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceResponsabilite/A-cote-texte-ass.jpg') }}" alt="Professionnels" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 order-2 order-lg-1">
                <img src="{{ asset('assets/img/assuranceResponsabilite/females-doctor-hospital-with-stethoscope.jpg') }}" alt="Médecin" class="img-fluid rounded shadow-lg w-100">
            </div>
...
<section class="py-5 d-flex align-items-center" style="background-image: url('{{ asset('assets/img/assuranceResponsabilite/image-14.jpg') }}'); background-size: cover; background-position: center; min-height: 500px;">
    <div class="container">
        <div class="row">
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceResponsabilite/default.jpg');
