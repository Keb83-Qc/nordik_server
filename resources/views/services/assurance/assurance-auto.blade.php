...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceAuto/reclamation-pour-accident-voiture.jpg') }}" alt="Agent assurance auto" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 order-2 order-lg-1">
                <img src="{{ asset('assets/img/assuranceAuto/vue-face-homme-assis-pres-voiture.jpg') }}" alt="Homme avec sa voiture" class="img-fluid rounded shadow-lg w-100">
            </div>
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceAuto/default.jpg');
