    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 text-center mt-4 mt-lg-0">
                <img src="{{ asset('assets/img/assuranceMaladieGrave/A-cote-texte-Maladies-Graves.jpg') }}" class="img-fluid rounded-4 shadow"
                    alt="Maladies Graves">
            </div>
        </div>
    </div>
...
<section class="section-padding bg-light">
    <div class="container">
        <div class="row g-5 align-items-center flex-lg-row-reverse">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceMaladieGrave/AdobeStock_727436851.jpg') }}" class="img-fluid rounded-4 shadow"
                    alt="RAMQ vs Private">
            </div>
        </div>
    </div>
