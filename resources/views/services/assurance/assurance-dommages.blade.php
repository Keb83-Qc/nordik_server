...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceDommages/jeune-couple-signant-contrat-location-tout-rencontrant-agent-immobilier-accent-est-mis-homme.jpg') }}"
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 mb-4 mb-lg-0 order-2 order-lg-1">
                <img src="{{ asset('assets/img/assuranceDommages/assurance-auto.jpg') }}" alt="Auto" class="img-fluid rounded shadow-lg">
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 mb-4 mb-lg-0 mt-4 mt-lg-0">
                <img src="{{ asset('assets/img/assuranceDommages/assurance-habitation.jpg') }}" alt="Habitation" class="img-fluid rounded shadow-lg">
            </div>
        </div>
    </div>
</section>
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceDommages/default.jpg');
