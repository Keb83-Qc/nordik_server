...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                {{-- Image --}}
                <img src="{{ asset('assets/img/assuranceInvaliditeDeGroupe/tech-people-trying-achieve-ambitious-sustainability-goals.jpg') }}"
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-{{ $i > 4 ? '4' : '3' }}">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3">
                        <img src="{{ asset('assets/img/assuranceInvaliditeDeGroupe/' . $icons[$i-1]) }}" width="64" alt="Icone">
                    </div>
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceInvaliditeDeGroupe/default.jpg');
