...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceCommerciale/AdobeStock_663298839.jpg') }}" alt="Assurance commerciale" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5 d-flex align-items-center" style="background-image: url('{{ asset('assets/img/assuranceCommerciale/assurance-commerciale-cout.jpg') }}'); background-size: cover; background-position: center; min-height: 500px;">
    <div class="container">
        ...
        <div class="row g-5 justify-content-center">
            <div class="col-md-5">
                <div class="d-flex align-items-start bg-white p-4 rounded shadow-sm h-100 hover-lift">
                    <img src="{{ asset('assets/img/assuranceCommerciale/risk-management_7392790.png') }}" width="70" class="me-4 flex-shrink-0" alt="Tous risques">
                    <div>
            ...
            <div class="col-md-5">
                <div class="d-flex align-items-start bg-white p-4 rounded shadow-sm h-100 hover-lift">
                    <img src="{{ asset('assets/img/assuranceCommerciale/risk-assessment_14105612.png') }}" width="70" class="me-4 flex-shrink-0" alt="Risques désignés">
                    <div>
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceCommerciale/default.jpg');
