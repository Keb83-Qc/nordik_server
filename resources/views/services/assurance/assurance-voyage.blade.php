...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceVoyage/coup-moyen-famille-heureuse-aeroport.jpg') }}" alt="Famille aéroport" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/assuranceVoyage/vaccination_3382495.png') }}" width="64" alt="Icone"></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/assuranceVoyage/no-travelling_4310444.png') }}" width="64" alt="Icone"></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/assuranceVoyage/quarantine_2746245.png') }}" width="64" alt="Icone"></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/assuranceVoyage/unable-travel_11354603.png') }}" width="64" alt="Icone"></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/assuranceVoyage/csr_11152667.png') }}" width="64" alt="Icone"></div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                ...
                <div class="row g-3 justify-content-center align-items-center">
                    <div class="col-6 col-sm-4 col-md-3"><img src="{{ asset('assets/img/assuranceVoyage/image-24.png') }}" class="img-fluid opacity-75 hover-opacity-100" alt="Partenaire"></div>
                    <div class="col-6 col-sm-4 col-md-3"><img src="{{ asset('assets/img/assuranceVoyage/image-24mm.png') }}" class="img-fluid opacity-75 hover-opacity-100" alt="Partenaire"></div>
                    <div class="col-6 col-sm-4 col-md-3"><img src="{{ asset('assets/img/assuranceVoyage/image-24t.png') }}" class="img-fluid opacity-75 hover-opacity-100" alt="Partenaire"></div>
                    <div class="col-6 col-sm-4 col-md-3"><img src="{{ asset('assets/img/assuranceVoyage/image-243.png') }}" class="img-fluid opacity-75 hover-opacity-100" alt="Partenaire"></div>
                    <div class="col-6 col-sm-4 col-md-3"><img src="{{ asset('assets/img/assuranceVoyage/image-243r.png') }}" class="img-fluid opacity-75 hover-opacity-100" alt="Partenaire"></div>
                    <div class="col-6 col-sm-4 col-md-3"><img src="{{ asset('assets/img/assuranceVoyage/image-243t2.png') }}" class="img-fluid opacity-75 hover-opacity-100" alt="Partenaire"></div>
                    <div class="col-6 col-sm-4 col-md-3"><img src="{{ asset('assets/img/assuranceVoyage/image-24des.png') }}" class="img-fluid opacity-75 hover-opacity-100" alt="Partenaire"></div>
                    <div class="col-6 col-sm-4 col-md-3"><img src="{{ asset('assets/img/assuranceVoyage/image-24a.png') }}" class="img-fluid opacity-75 hover-opacity-100" alt="Partenaire"></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceVoyage/default.jpg');
