...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assuranceVie/A-cote-texte-assurance-vie-1.jpg') }}" alt="{{ __('assurance-vie.title') }}" class="img-fluid rounded shadow-lg">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center bg-white rounded-4 hover-lift">
                    <div class="mb-3">
                        <img src="{{ asset('assets/img/assuranceVie/Protection-du-revenu.png') }}" alt="{{ __('assurance-vie.card_1_title') }}" style="width: 70px; height: auto;">
                    </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center bg-white rounded-4 hover-lift">
                    <div class="mb-3">
                        <img src="{{ asset('assets/img/assuranceVie/Paiement-des-dettes.png') }}" alt="{{ __('assurance-vie.card_2_title') }}" style="width: 70px; height: auto;">
                    </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center bg-white rounded-4 hover-lift">
                    <div class="mb-3">
                        <img src="{{ asset('assets/img/assuranceVie/Securite-financiere.png') }}" alt="{{ __('assurance-vie.card_3_title') }}" style="width: 70px; height: auto;">
                    </div>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center bg-white rounded-4 hover-lift">
                    <div class="mb-3">
                        <img src="{{ asset('assets/img/assuranceVie/Protection-du-revenu.png') }}" alt="{{ __('assurance-vie.perm_card_1_title') }}" style="width: 70px; height: auto;">
                    </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center bg-white rounded-4 hover-lift">
                    <div class="mb-3">
                        <img src="{{ asset('assets/img/assuranceVie/Paiement-des-dettes.png') }}" alt="{{ __('assurance-vie.perm_card_2_title') }}" style="width: 70px; height: auto;">
                    </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center bg-white rounded-4 hover-lift">
                    <div class="mb-3">
                        <img src="{{ asset('assets/img/assuranceVie/Securite-financiere.png') }}" alt="{{ __('assurance-vie.perm_card_3_title') }}" style="width: 70px; height: auto;">
                    </div>
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-3">
                <div class="text-center p-4 bg-white rounded shadow-sm h-100 hover-lift">
                    <img src="{{ asset('assets/img/assuranceVie/beneficiary_6000659-1.png') }}" alt="Famille" class="mb-3" width="80">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-center p-4 bg-white rounded shadow-sm h-100 hover-lift">
                    <img src="{{ asset('assets/img/assuranceVie/insurance-policy_10279437.png') }}" alt="Succession" class="mb-3" width="80">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-center p-4 bg-white rounded shadow-sm h-100 hover-lift">
                    <img src="{{ asset('assets/img/assuranceVie/money_2960150.png') }}" alt="Investissement" class="mb-3" width="80">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-center p-4 bg-white rounded shadow-sm h-100 hover-lift">
                    <img src="{{ asset('assets/img/assuranceVie/homework-help_15051664.png') }}" alt="Éducation" class="mb-3" width="80">
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceVie/default.jpg');
