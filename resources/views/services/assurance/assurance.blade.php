...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/assurances/Assurances.jpg') }}" alt="Assurance VIP GPI" class="section-img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="{{ url('/' . $svc['link']) }}" class="service-grid-card"
                    style="background-image: url('{{ asset('assets/img/assurances/' . $svc['image']) }}');">
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assurances/default.jpg');
