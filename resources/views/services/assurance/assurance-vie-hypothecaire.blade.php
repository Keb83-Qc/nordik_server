    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <img src="{{ asset('assets/img/assuranceVieHypothecaire/A-cote-texte-hypotheeque.jpg') }}" alt="Assurance vie hypothécaire"
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/assuranceVieHypothecaire/icons-2.png') }}" width="64" alt="Icone"></div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/assuranceVieHypothecaire/icons-1.png') }}" width="64" alt="Icone"></div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/assuranceVieHypothecaire/icons-3.png') }}" width="64" alt="Icone"></div>
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4">
                <div class="d-flex align-items-start p-3 border rounded h-100 hover-lift bg-light">
                    <img src="{{ asset('assets/img/assuranceVieHypothecaire/insurance_1955512.png') }}" width="50" class="me-3 mt-1" alt="Icone">
                    <div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex align-items-start p-3 border rounded h-100 hover-lift bg-light">
                    <img src="{{ asset('assets/img/assuranceVieHypothecaire/b2c_4775304.png') }}" width="50" class="me-3 mt-1" alt="Icone">
                    <div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex align-items-start p-3 border rounded h-100 hover-lift bg-light">
                    <img src="{{ asset('assets/img/assuranceVieHypothecaire/fair-trade_4668463.png') }}" width="50" class="me-3 mt-1"
                        alt="Icone">
                    <div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex align-items-start p-3 border rounded h-100 hover-lift bg-light">
                    <img src="{{ asset('assets/img/assuranceVieHypothecaire/paperwork_8092235.png') }}" width="50" class="me-3 mt-1" alt="Icone">
                    <div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex align-items-start p-3 border rounded h-100 hover-lift bg-light">
                    <img src="{{ asset('assets/img/assuranceVieHypothecaire/profile_13192937.png') }}" width="50" class="me-3 mt-1" alt="Icone">
                    <div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex align-items-start p-3 border rounded h-100 hover-lift bg-light">
                    <img src="{{ asset('assets/img/assuranceVieHypothecaire/trial_10930240.png') }}" width="50" class="me-3 mt-1" alt="Icone">
                    <div>
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceVieHypothecaire/default.jpg');
