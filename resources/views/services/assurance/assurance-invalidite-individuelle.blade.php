...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                {{-- Image --}}
                <img src="{{ asset('assets/img/assuranceInvaliditeIndividuelle/ques-ce-que-lassurance-invalidite-individuelle.png') }}" alt="{{ __('assurance-invalidite-individuelle.title') }}" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <img src="{{ asset('assets/img/assuranceInvaliditeIndividuelle/les-anvantages-de-lass-invalidite-individuelle-PNG.png') }}" alt="{{ __('assurance-invalidite-individuelle.advantages_title') }}" class="img-fluid rounded shadow-lg w-100">
            </div>
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/assuranceInvaliditeIndividuelle/default.jpg');
