...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/prets/A-droite-texte-Prets.jpg') }}" alt="Solutions de prêts" class="section-img rounded shadow hover-lift w-100">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-3">
                <a href="{{ url($item['l']) }}" class="service-grid-card small-card d-block position-relative rounded overflow-hidden shadow-sm hover-lift"
                    style="height: 250px; background-image: url('{{ asset('assets/img/prets/'.$item['i']) }}'); background-size: cover; background-position: center;">
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/prets/default.jpg');
