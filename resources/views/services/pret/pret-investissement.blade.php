...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/pretInvestissement/quest-ce-quun-pret-pour-investissement.png') }}" alt="Prêt investissement" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 order-2 order-lg-1">
                <img src="{{ asset('assets/img/pretInvestissement/pret-Investissement.png') }}" alt="Pourquoi prêt" class="img-fluid rounded shadow-lg w-100">
            </div>
...
<section class="section-padding d-flex align-items-center" style="background-image: url('{{ asset('assets/img/pretInvestissement/AdobeStock_713694880.jpg') }}'); background-size: cover; background-position: center; min-height: 600px;">
    <div class="container">
        <div class="row">
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/pretInvestissement/default.jpg');
