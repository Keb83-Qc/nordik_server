        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal">
                    <img src="{{ asset('assets/img/carteCredit/image-21.jpg') }}" alt="Carte de crédit" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 order-2 order-lg-1 text-center">
                <img src="{{ asset('assets/img/carteCredit/image-221.jpg') }}" alt="App Neo" class="img-fluid rounded shadow-lg" style="max-height: 600px;">
            </div>
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/carteCredit/default.jpg');
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content bg-transparent border-0 shadow-none">
            <div class="modal-body p-0 position-relative text-center">
                ...
                <img src="{{ asset('assets/img/carteCredit/image-21.jpg') }}" class="img-fluid rounded shadow-lg" alt="Carte de crédit">
            </div>
        </div>
    </div>
</div>
