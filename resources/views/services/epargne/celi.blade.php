...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/celi/Quest-ce-que-le-Celi.png') }}" alt="CELI" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>

<section class="section-padding d-flex align-items-center" style="background-image: url('{{ asset('assets/img/celi/Les-droits-de-cotisations-au-CELI.jpg') }}'); background-size: cover; background-position: center; min-height: 600px;">
    <div class="container">
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center text-center">
            <div class="col-md-4">
                <div class="mb-3"><img src="{{ asset('assets/img/celi/18_2141502.png') }}" width="64" alt="18"></div>
                <h5 class="fw-bold">{{ __('celi.crit_1') }}</h5>
            </div>
            <div class="col-md-4">
                <div class="mb-3"><img src="{{ asset('assets/img/celi/supreme-court_6744453.png') }}" width="64" alt="Résident"></div>
                <h5 class="fw-bold">{{ __('celi.crit_2') }}</h5>
            </div>
            <div class="col-md-4">
                <div class="mb-3"><img src="{{ asset('assets/img/celi/social-security_10880567.png') }}" width="64" alt="NAS"></div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/celi/tax_3200773.png') }}" width="64" alt="Retrait"></div>
                    <h5 class="fw-bold mb-2">{{ __('celi.mod_1') }}</h5>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/celi/transfer_11542718.png') }}" width="64" alt="Transfert"></div>
                    <h5 class="fw-bold mb-2">{{ __('celi.mod_2') }}</h5>
                </div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/celi/cargo_7074830.png') }}" width="64" alt="Placements"></div>
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/celi/default.jpg');
