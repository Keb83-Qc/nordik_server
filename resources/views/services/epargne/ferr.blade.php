...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/ferr/A-cote-texte-FERR.jpg') }}" alt="FERR Retraite" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-{{ $loop->iteration > 3 ? '3' : '4' }}">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/ferr/' . $p['icon']) }}" width="64" alt="Icone"></div>
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/ferr/default.jpg');
