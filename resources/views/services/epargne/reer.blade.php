    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <span class="badge bg-success text-white mb-2">{{ __('reer.badge') }}</span>
            ...
            <div class="col-lg-6">
                {{-- Image Hero --}}
                <img src="{{ asset('assets/img/reer/Quest-ceque-le-REER.jpg') }}" alt="REER" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 order-1 order-lg-2 ps-lg-5 mb-4">
                ...
                <img src="{{ asset('assets/img/reer/Combine-puis-je-cotiser-a-mon-CELI.jpg') }}" alt="Caractéristiques REER" class="img-fluid rounded shadow mt-3 w-100">
            </div>
        ...
        <div class="row align-items-start">
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-lg overflow-hidden h-100">
                    <img src="{{ asset('assets/img/reer/AdobeStock_230329183.jpg') }}" alt="Retraite heureuse" class="card-img-top object-fit-cover" style="height: 200px;">
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/reer/default.jpg');
