    ...
    <section class="section-padding bg-white">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('assets/img/epargne/epargne-intro.jpg') }}" class="section-img rounded shadow" alt="Épargne">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="{{ $item['l'] }}" class="service-grid-card small-card d-block position-relative rounded overflow-hidden shadow-sm hover-lift"
                        style="height: 200px; background-image: url('{{ asset('assets/img/epargne/'.$item['i']) }}'); background-size: cover; background-position: center;">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <a href="/reee" class="service-grid-card small-card d-block position-relative rounded overflow-hidden shadow-sm hover-lift"
                        style="height: 200px; background-image: url('{{ asset('assets/img/epargne/epargne-reee.jpg') }}'); background-size: cover; background-position: center;">
                        <div style="background: rgba(0,0,0,0.4); width: 100%; height: 100%; display: flex; align-items: center; justify-content: center;">
