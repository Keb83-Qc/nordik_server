...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/pretHypothecaire/quest-ce-quun-pret-hypothecaire.jpg') }}" alt="Prêt hypothécaire" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3"><img src="{{ asset('assets/img/pretHypothecaire/' . $a['icon']) }}" width="64" alt="Icone"></div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 mb-4 mb-lg-0 text-center">
                <img src="{{ asset('assets/img/pretHypothecaire/AdobeStock_536174812.png') }}" alt="Calcul prêt" class="img-fluid" style="max-height: 400px;">
            </div>
            <div class="col-lg-7">
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/pretHypothecaire/default.jpg');
