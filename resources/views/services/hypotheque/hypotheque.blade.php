...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/hypotheque/A-cote-texte-hypotheeque.jpg') }}" alt="Courtier hypothécaire" class="section-img rounded shadow hover-lift w-100">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-6">
                <a href="{{ url('/hypotheque/programme-dachat-clef-en-main') }}" class="service-grid-card small-card d-block position-relative rounded overflow-hidden shadow-sm hover-lift"
                    style="height: 300px; background-image: url('{{ asset('assets/img/hypotheque/achat-clef-en-main.png') }}'); background-size: cover; background-position: center;">
            ...
            <div class="col-md-6">
                <a href="{{ url('/hypotheque/pret-hypothecaire') }}" class="service-grid-card small-card d-block position-relative rounded overflow-hidden shadow-sm hover-lift"
                    style="height: 300px; background-image: url('{{ asset('assets/img/hypotheque/pret-hypothecaire.jpg') }}'); background-size: cover; background-position: center;">
                    <div style="background: rgba(14, 16, 48, 0.6); width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; transition: background 0.3s;">
...
<section class="section-padding bg-white">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/hypotheque/default.jpg');
