...
<section class="section-padding bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                {{-- Image --}}
                <img src="{{ asset('assets/img/achatClefEnMain/AdobeStock_305225678.jpg') }}" alt="{{ __('programme-dachat-clef-en-main.title') }}" class="section-img rounded shadow hover-lift w-100 object-fit-cover">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 order-2 order-lg-1">
                {{-- Image --}}
                <img src="{{ asset('assets/img/achatClefEnMain/AdobeStock_672446165.png') }}" alt="{{ __('programme-dachat-clef-en-main.objective_title') }}" class="img-fluid rounded w-100">
            </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm p-4 text-center hover-lift">
                    <div class="mb-3">
                        <img src="{{ asset('assets/img/achatClefEnMain/' . $icons[$i-1]) }}" width="64" alt="Icone">
                    </div>
...
<section class="section-padding bg-light">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $imgSrc = !empty($post->image) ? asset($post->image) : asset('assets/img/achatClefEnMain/default.jpg');
