    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 80vh;">
        <div class="card shadow-lg border-0 rounded-4 p-4 text-center" style="max-width: 500px;">
            <div class="card-body">
                ...
                @php
                    $code = session('current_advisor_code') ?? session('last_advisor_code');
                @endphp
                ...
                <div class="d-grid gap-2">
                    ...
                    @if($code)
                        <a href="{{ route('consent.show', ['locale' => app()->getLocale(), 'code' => $code]) }}"
                        class="btn btn-outline-primary btn-lg w-100 rounded-pill">
                            Retour au consentement <i class="fas fa-file-signature ms-2"></i>
                        </a>
                    @endif
                </div>
